...
namespace EstoqueApp.Infrastructure.Migrations
{
    ...
    [Migration("20250130202306_TabelaProdutosOrcamento")]
    partial class TabelaProdutosOrcamento
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EstoqueApp.Domain.Cliente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("EstoqueApp.Domain.Orcamento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("EstoqueApp.Domain.ProdutosOrcamento", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasKey("Id", "OrcamentoId", "ProdutoId");
            ...
            modelBuilder.Entity("EstoqueApp.Domain.TipoEvento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("EstoqueApp.Domain.Orcamento", b =>
                {
                    b.HasOne("EstoqueApp.Domain.Cliente", "Cliente")
                        .WithMany()
                        .HasForeignKey("ClienteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EstoqueApp.Domain.TipoEvento", "TipoEvento")
                        .WithMany()
            ...
            modelBuilder.Entity("EstoqueApp.Domain.ProdutosOrcamento", b =>
                {
                    b.HasOne("EstoqueApp.Domain.Orcamento", "Orcamento")
